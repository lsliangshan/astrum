...
class CreateAttachmentView extends GetView {
  final String roleId;
  ...
  CreateAttachmentView({
    ...
    if (attachmentId != null && attachmentId!.isNotEmpty) {
      Get.put<CreateAttachmentController>(
        CreateAttachmentController(
          roleId: roleId,
          roleName: roleName,
          attachmentId: attachmentId,
        ),
        tag: 'create-attachment-$roleId-$attachmentId',
      );
    } else {
      Get.put<CreateAttachmentController>(
        CreateAttachmentController(roleId: roleId, roleName: roleName),
        tag: 'create-attachment-$roleId',
      );
    }
  }

  @override
  CreateAttachmentController get controller =>
      (attachmentId != null && attachmentId!.isNotEmpty)
      ? Get.find<CreateAttachmentController>(
          tag: 'create-attachment-$roleId-$attachmentId',
        )
      : Get.find<CreateAttachmentController>(tag: 'create-attachment-$roleId');
