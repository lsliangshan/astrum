...
class Messages extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'zh_CN': {
      ...
      'add_role.prompt': '角色提示词',
      'add_role.prompt.hint': '请输入角色提示词',
      'add_role.icon': '角色图标',
    ...
    'en_US': {
      ...
      'add_role.prompt': 'Role Prompt',
      'add_role.prompt.hint': 'Please enter the role prompt',
      'add_role.icon': 'Icon',
      ...
      'role_detail.prompt': 'Role Prompt',
